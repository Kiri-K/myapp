...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Example:
        let controller1 : UIViewController = page1()
        controller1.title = "Rank"
        controllerArray.append(controller1)
        
        let controller2 : UIViewController = page2()
        controller2.title = "New"
        controllerArray.append(controller2)
        
        let controller3 : UIViewController = page3()
        controller3.title = "さがす"
        controllerArray.append(controller3)
        
        let controller4 : UIViewController =  page4()
